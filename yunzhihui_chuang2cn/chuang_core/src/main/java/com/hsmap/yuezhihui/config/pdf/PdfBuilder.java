...
public class PdfBuilder extends PdfPageEventHelper {
     ...
     */
    public PdfBuilder(String header, int presentFontSize, Rectangle pageSize, File watermark,
                      boolean isHeaderFooter, String fontRoot) {
        this.header = header;
        this.presentFontSize = presentFontSize;
        this.pageSize = pageSize;
        this.watermark = watermark;
...
//                再判断fooroot
                if (fontRoot != null) {
                    bf = BaseFont.createFont(fontRoot + "STFANGSO.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
                } else {
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_LEFT,
                new
                        ...
                        Phrase(header, fontDetail), document.
    ...
    public void addWatermark(PdfWriter writer) {
        ...
        Image image = null;
        try {
            image = Image.getInstance(FileUtils.file2Byte(watermark));
