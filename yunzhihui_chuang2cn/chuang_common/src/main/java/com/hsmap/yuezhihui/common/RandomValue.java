...
public class RandomValue {
     ...
     * 返回手机号码
     */
    private static String[] telFirst = "133,149,153,173,177,180,181,189,199,130,131,132,145,155,156,166,171,175,176,185,186,166,134,135,136,137,138,139,147,150,151,152,157,158,159,172,178,182,183,184,187,188,198,170".split(",");
     ...
     * @return
     */
    public static String getMobileNumber(boolean isdesens){
        String mobileNumber = getTel();
        if(isdesens){
...
//        Math.random()
        ...
        double d = Math.random()*100*30/1000*3;
        return df.format( d);
    }

    public static int getNumber() {
        Double d = Math.random() * 12;
        int num = d.intValue() + 1;
        return num;
    }


    public static List<Integer> getNumberList(int count) {
...
//        for (int s : getNumberList(12)) {
//            System.out.println(s);
//        }
//        String mobile = getTel();
        //System.out.println(mobile.substring(0,3)+"****"+mobile.substring(7));
//        System.out.println(getMobileNumber(true));

        for(int i =0;i<100;i++) {
            //String mobile = getChineseName();
            String ages = CommonUtil.getRandomByCount(2);
